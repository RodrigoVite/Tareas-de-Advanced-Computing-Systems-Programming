...
int main(int argc, char const *argv[]){
	int opt=0;
	int fdBoleta, fdCont;
	char boleta[N], cont[N];

	while(1){
		fdCont 		= abrirParametro("/sys/module/boleta/parameters/cont");
		fdBoleta 	= abrirParametro("/sys/module/boleta/parameters/boleta");
